(function(){
  ...
  var TK=[
    {n:'01',t:'What the playbook covers, section by section.',
     w:'Four areas: benchmarking model capabilities in your domain, harness engineering to improve frontier performance, productionizing and scaling up, and retaining moats as the models move under you.',
    ...
    {n:'02',t:'Why the moat sits in expert-graded tasks.',
     w:'If a task has a machine-checkable reward, it gets RL\u2019d into the next model. Tarun Raheja\u2019s argument for where that leaves a vertical product, and what he has built that informs it.',
    ...
    {n:'03',t:'The loop: map, improve, productionize, re-evaluate.',
     w:'Building a vertical AI product is a loop, not a build. Find where the model is weak task by task, improve the output in those specific areas, harden it against real edge cases, then re-evaluate on every release and delete the scaffolding a new model made redundant.',
    ...
    {n:'04',t:'The full report, plus the checklist it ships with.',
     w:'The complete playbook as a document, with the checklist to run it against. Run it quarterly, and again within 48 hours of every model release.',
  ...
  var TK_LINK=[
    ...
    {h:'#twk2-author',l:'About the author \u2192'},

...
`},B=e=>`
  <div fs-cmsnest-element="list-2" role="list" class="items-cl w-dyn-items">${e.map(s=>ge(s)).join("")}</div>`,ge=e=>{let{id:t,name:i,description:s,icon:o,cardBackground:a,twitterHandle:g,githubRepo:d,category:l,subCategories:u,discordServer:y,telegramChannel:f,coingeckoLink:b,websiteLink:m,linkedinLink:Be,spnProfile:M}=e;return`<div role="listitem" class="items-ci w-dyn-item">
...
`},D=(e,t)=>{let i=c.after,s=c.limit,o=3,a=[],g=parseInt(i/s)+1,d=parseInt((e-1)/s)+1;a.push(1),g>3&&a.push("...");let l=Math.max(g-Math.floor(o/2),2),u=Math.min(l+o-1,d-1);u-l<o-2&&(l=Math.max(u-o+2,2));for(let f=l;f<=u;f++)a.push(f);return u<d-1&&a.push("..."),d>1&&a.push(d),`

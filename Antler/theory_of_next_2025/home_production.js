if (window.location.hostname === "www.theoryofnext.com") {
  ...
  //   // Detect transition across the 991px breakpoint
  ...
  //   // Always update previousWidth for next comparison
  //   previousWidth = currentWidth;

  //   // Optional: Run this only when in desktop mode
  //   if (currentWidth > 991) {
  ...
  function initHoveringBtnAnimation() {
    if (window.innerWidth > 991) {
      ...
      // const resourcesHoverBtnTl = gsap.timeline({
      //   scrollTrigger: {
      //     trigger: ".final-cta-container-ete",
      //     start: "top top",
      //     end: "bottom top",
      //     // markers: true,
      //     toggleActions: "play reverse play reverse",
      ...
      // resourcesHoverBtnTl.addLabel("btnOpen");

      // resourcesHoverBtnTl.fromTo(
      //   "#resources-hover-btn",
      //   {
      //     scale: 0,
      //     width: "0rem",
      ...
      // resourcesHoverBtnTl.fromTo(
      //   "#resources-hover-btn .al-icon-wrapper",
      //   {
      //     scale: 0,
      //   },
      //   {
      ...
      // resourcesHoverBtnTl.to("#resources-hover-btn ", {
      //   borderRadius: "18px",
      //   width: "18rem",
      //   duration: 1,
      // });

      // resourcesHoverBtnTl.to(
      //   "#resources-hover-btn .al-icon-wrapper",
      //   {
      //     right: "-5px",
      //   },
      ...
      // resourcesHoverBtnTl.fromTo(
      //   "#resources-hover-btn .at-arrow-icon",
      //   {
      //     // clipPath: "circle(0% at 50% 50%)", // starting as a tiny circle
      //     borderRadius: "50px",
      //   },
      ...
      // resourcesHoverBtnTl.from(
      //   [
      //     "#resources-hover-btn .all-theme-btn-text",
      //     "#resources-hover-btn .themes-icon-wrapper",
      //   ],
      //   {
      //     scale: 0,
      //     ease: "back.out(0.5)",
  ...
  const initializethemesAnimation = () => {
    ...
    if (window.innerWidth > 991) {
      ...
      themesTl.from(".themes-theme-card", {
        width: "5.4rem",
        duration: 0.4,
        ease: "power2.out",
      });
      ...
      themesTl.addLabel("CardsUnfold", "<0.2");
    ...
    // if (window.innerWidth < 991) {
    //   const vhToPx = window.innerHeight * (100 / 500);
    //   const themesTl = gsap.timeline({
    //     scrollTrigger: {
    //       trigger: ".themes-intro-container",
    //       start: "top top",
    ...
    //   // Animate the paragraph container
    //   themesTl.from(
    //     [".themes-para-container", ".themes-cards-window"],
    //     {
    //       opacity: 0,
    //       duration: 0.3,
    //       ease: "power2.out",
  ...
  //   // Adjust this if your tablet design breaks at a different width
  //   return isTouchDevice && isLandscape && screenWidth <= 1024;
  // }

  // function showTabletLandscapePopup() {
  ...
  //   showTabletLandscapePopup();
  // });

  // window.addEventListener("resize", showTabletLandscapePopup);
  // window.addEventListener("orientationchange", showTabletLandscapePopup);

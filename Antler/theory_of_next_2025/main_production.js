if (window.location.hostname === "www.theoryofnext.com") {
  document.addEventListener("DOMContentLoaded", () => {
    ...
    // function initializeBarbaTransitions() {
    ...
    //               homeInit();
    //               homeLottieAnimation();
    //             } else if (next.namespace === "ideas") {
    //               ideasInit();
    //             } else if (next.namespace === "resources") {
    //               initializeOrbitAnimations();
    //             }
    //             await curtainOut();
    //           },
    ...
    //     });
    //   } else {
    //     console.log("Barba is not present on this page.");
    //   }
    // }
  ...
  function initShareThoughtsInteractions() {
    ...
    trigger.addEventListener("mouseenter", () => {
      hoverTarget.classList.add("is-open");
    });

    trigger.addEventListener("mouseleave", () => {
      hoverTarget.classList.remove("is-open");
    });
